...
<body>
    <?php
        $input_1 = new input("text","inputUsuario","matricula","CLAVE DE TRABAJADOR","^[0-9]*$","",0);
        $input_2 = new input("password","inputPassword","pass","'Contraseña:'","^[a-zA-Z0-9]*$","",0);
        $label_1 = new label_solo_lectura("id_user","Matrícula de Trabajador:");
        $label_2 = new label_solo_lectura("password","Contraseña:");
        $inputs = [$input_1,$input_2];
        $labels = [$label_1,$label_2];
    ?>
    <h1 class="form-signin-heading">Constancias de Ceneval</h1>
    <div class="container">
        <form action="generadorConstanciasCeneval.php" class="form-signin" method="post">   
